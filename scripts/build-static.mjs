...
const artworks = [
  { slug: "two-strokes", title: "Two Strokes, One Breath", year: 2026, medium: "Sumi ink on handmade paper", image: A("art-1.jpg"), description: "An exercise in restraint — the whole composition completed in a single exhale." },
  { slug: "stacks", title: "Stacks", year: 2025, medium: "35mm film, silver gelatin print", image: A("art-2.jpg"), description: "Reading room of the Biblioteca Marciana, an hour before closing." },
  { slug: "blue-ridge", title: "Blue Ridge, From Memory", year: 2025, medium: "Graphite on journal paper", image: A("art-3.jpg"), description: "Drawn on a train, two weeks after the trip, with the curtains down." },
  { slug: "cup-and-pear", title: "Cup and Pear", year: 2024, medium: "Oil on linen", image: A("art-4.jpg"), description: "A small still life. The pear sat there for six days before I finished." },
];

const notes = [
  { id: "n-12", date: "March 28, 2026 · 7:14am", kind: "thought", body: "Most of what I call indecision is actually unwillingness to feel the loss of the road not taken." },
  { id: "n-11", date: "March 24, 2026", kind: "quote", body: "“Attention is the rarest and purest form of generosity.”", source: "Simone Weil" },
  { id: "n-10", date: "March 19, 2026", kind: "observation", body: "The woman in the café asked the waiter for 'a coffee, but slow'. He nodded as if this was a known order." },
  { id: "n-9", date: "March 15, 2026", kind: "thought", body: "An interesting life is mostly a function of which boring things you're willing to do daily." },
  { id: "n-8", date: "March 11, 2026", kind: "link", body: "Re-reading John Berger's letters to Subcomandante Marcos. Astonishing.", source: "tinyletters.cc/berger" },
  { id: "n-7", date: "March 8, 2026", kind: "thought", body: "Style is what's left after you stop trying to be liked." },
];
